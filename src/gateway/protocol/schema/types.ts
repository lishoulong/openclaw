...
export type TeamMember = SchemaType<"TeamMember">;
export type TeamConfig = SchemaType<"TeamConfig">;
export type TeamRun = SchemaType<"TeamRun">;
export type TeamTask = SchemaType<"TeamTask">;
export type TeamsListParams = SchemaType<"TeamsListParams">;
export type TeamsListResult = SchemaType<"TeamsListResult">;
export type TeamsGetParams = SchemaType<"TeamsGetParams">;
export type TeamsGetResult = SchemaType<"TeamsGetResult">;
export type TeamsRunTaskInput = SchemaType<"TeamsRunTaskInput">;
export type TeamsRunParams = SchemaType<"TeamsRunParams">;
export type TeamsRunResult = SchemaType<"TeamsRunResult">;
export type TeamsRunGetParams = SchemaType<"TeamsRunGetParams">;
export type TeamsRunGetResult = SchemaType<"TeamsRunGetResult">;
export type TeamsRunCancelParams = SchemaType<"TeamsRunCancelParams">;
export type TeamsRunCancelResult = SchemaType<"TeamsRunCancelResult">;
export type TeamsTasksListParams = SchemaType<"TeamsTasksListParams">;
export type TeamsTasksListResult = SchemaType<"TeamsTasksListResult">;
