...
import {
  ...
  type TeamsGetResult,
  TeamsGetResultSchema,
  type TeamsListParams,
  TeamsListParamsSchema,
  type TeamsListResult,
  TeamsListResultSchema,
  type TeamsRunCancelParams,
  TeamsRunCancelParamsSchema,
  type TeamsRunCancelResult,
  TeamsRunCancelResultSchema,
  type TeamsRunGetParams,
  TeamsRunGetParamsSchema,
  type TeamsRunGetResult,
  TeamsRunGetResultSchema,
  type TeamsRunParams,
  TeamsRunParamsSchema,
  type TeamsRunResult,
  TeamsRunResultSchema,
  type TeamsRunTaskInput,
  TeamsRunTaskInputSchema,
  type TeamsTasksListParams,
  TeamsTasksListParamsSchema,
  type TeamsTasksListResult,
  TeamsTasksListResultSchema,
...
export const validateTeamsRunGetParams = ajv.compile<TeamsRunGetParams>(TeamsRunGetParamsSchema);
export const validateTeamsRunCancelParams = ajv.compile<TeamsRunCancelParams>(
  TeamsRunCancelParamsSchema,
);
export const validateTeamsTasksListParams = ajv.compile<TeamsTasksListParams>(
  TeamsTasksListParamsSchema,
);
...
export type {
  ...
  TeamsRunGetParams,
  TeamsRunGetResult,
  TeamsRunCancelParams,
  TeamsRunCancelResult,
  TeamsTasksListParams,
  TeamsTasksListResult,
  WakeParams,
